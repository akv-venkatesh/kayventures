                  ...
                  <div className="row d-flex align-items-center">
                    ...
                    <div className="col-md-5 end">
                      <div className="position-relative">
                        ...
                        <Field aria-label="upload_logo" type="file" id="upload-logo" name="upload_logo"  onChange={this.onImageChange} hidden/>
                        <label htmlFor="upload_logo_img"><img src={ this.state.logoImage ? this.state.logoImage : logo_img }  className="logo-img" /></label>
                      </div>
                    </div>
                  </div>
