...
function ManufacturerLogin():JSX.Element {
	const [show, setShow] = useState<boolean>(false);
	const [psw_vis, setPSW_vis] = useState<boolean>(false);
				    					...
				    					<form onSubmit={handleSubmit}>
						    				...
						    				<div className="position-relative">
							    				<div className="mt-sm-5 mt-4 d-flex align-items-center">
							    					...
							    					/>
							    					{ psw_vis ? 
							    						<FaEyeSlash className="eye-icon" onClick={psw_visible}/> :
							    						<FaEye className="eye-icon" onClick={psw_visible}/>
							    					}
							    				</div>
						    					<div className="validation-error">
