				    			...
				    			<div className="weekday mb-5">
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="mon_start_time_day" value="1" className=" custom-control-input d-none" id="mon-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="mon_end_time_day" value="1" className=" custom-control-input d-none" id="mon-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="tue_start_time_day" value="1" className=" custom-control-input d-none" id="tue-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="tue_end_time_day" value="1" className=" custom-control-input d-none" id="tue-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="wed_start_time_day" value="1" className=" custom-control-input d-none" id="wed-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="wed_end_time_day" value="1" className=" custom-control-input d-none" id="wed-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="thur_start_time_day" value="1" className=" custom-control-input d-none" id="thur-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="thur_end_time_day" value="1" className=" custom-control-input d-none" id="thur-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="fri_start_time_day" value="1" className=" custom-control-input d-none" id="fri-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="fri_end_time_day" value="1" className=" custom-control-input d-none" id="fri-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="sat_start_time_day" value="1" className=" custom-control-input d-none" id="sat-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="sat_end_time_day" value="1" className=" custom-control-input d-none" id="sat-end-time-day"/>
						    		...
						    		<div className="d-flex align-items-center py-3">
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="am" name="sun_start_time_day" value="1" className=" custom-control-input d-none" id="sun-start-time-day"/>
						    			...
						    			<div className="start d-flex align-items-center">
						    				...
						    				<div>
						    					<div className="custom-control custom-checkbox ms-3">
												  	<Field type="checkbox" value="pm" name="sun_end_time_day" value="1" className=" custom-control-input d-none" id="sun-end-time-day"/>
