...
export const OrganizationinfoModal1 = React.lazy(() => import('../pages/settings/kyc/Organization/OrganizationinfoModal'));
...
export const MachineryInitialPage = React.lazy(() => import('../pages/settings/kyc/Machinery/MachineryInitialPage'));
